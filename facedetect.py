...
def facefinder(files,nested=None,cascade=None,detected=False,show=True,loglevel='INFO') :
    ...
    for f in files :
        ...
        logger.info("Detected: {} faces, {} eyes in  {} ms on {f}".format(len(rects), len(subrects), clock()-t, **locals()))
